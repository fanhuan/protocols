...
i. find the contigs that has annotation from this taxid.  
		...
		python ~/scripts/ContigGraber.py 178901
ii. map reads to those contigs following instructions [here](https://github.com/voutcn/megahit/wiki/An-example-of-real-assembly). Then map those reads to the genome of A. malorum.  

		export PATH=$PATH:/home/hfan/build/bbmap
		bbwrap.sh ref=178901.fa in=/media/backup_2tb/Data/FlyMicrobiome/nonDrosophila/Round4/nonDrosophila_#.fq.gz out=178901.sam.gz kfilter=22 subfilter=15 maxindel=80
  ...
  So in this case, I want my read to be paired, mapped in proper pair, read mapped
